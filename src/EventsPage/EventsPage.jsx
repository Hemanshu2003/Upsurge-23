    ...
    <div className="EventsPage">
      <div className="EventsPage_container">
          ...
          <div className="EventsPage_card-textbox">
            ...
            <div className="btnbtn">
              <a
                ...
                href="https://konfhub.com/agora-seminar"
              >
        ...
        <div className="EventsPage_card EventsPage_card__2n ">
          ...
          <div className="EventsPage_card-textbox">
            ...
            <div className="btnbtn">
              <a
                className="events_link"
                href="https://konfhub.com/web3-seminar"
              >
                <button className="events_btn">
                  <svg
                    height="44px"
        ...
        <div className="EventsPage_card">
          <img
            className="EventsPage_card-img"
            src="https://campusfestbucket.s3.us-west-1.amazonaws.com/Upsurge/Events/4_3/CYBER+SECURITY+Medium.png"
          />
          <div className="EventsPage_card-textbox">
            <div className="EventsPage_card-title">
              <h2>HandsOn Session on CYBER Security </h2>
            </div>
            <div className="EventsPage_card-description">
              <p>
            ...
            <div className="btnbtn">
              <a
                className="events_link"
                href="https://konfhub.com/handson-cyber"
              >
                <button className="events_btn">
                  <svg
                    height="44px"
        ...
        <div className="EventsPage_card EventsPage_card__2n">
          ...
          <div className="EventsPage_card-textbox">
            ...
            <div className="btnbtn">
              <a
                className="events_link"
                href="https://konfhub.com/linkedin-seminar"
              >
                <button className="events_btn">
                  <svg
                    height="44px"
        ...
        <div className="EventPage_innerContainer">
          <div className="EventsPage_card">
            <img
              className="EventsPage_card-img"
            ...
            <div className="EventsPage_card-textbox ">
              ...
              <div className="EventsPage_card-description">
                <p>
                  ...
                  two thrilling competitions: Trending Rhythms: Express yourself
                  through dance or creative acts set to the hottest trends.
                  Whether solo or in a group, showcase your artistic
                  interpretation of popular songs. Register easily with Google
                  Forms, and the entry fee for Trending Rhythms is just 50 INR.
                  Captured Campus: Grab your smartphone (no cameras) and capture
                  the essence of our campus through your lens. Transform
