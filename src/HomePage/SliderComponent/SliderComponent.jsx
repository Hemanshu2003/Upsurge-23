    ...
    <div className="slider-section" id="events">
      ...
      >
        ...
        <SwiperSlide>
          ...
          />
          <div className="slide_content">
            <h1 className="slide_heading">FIFA fever cup</h1>
            <p>
              FIFA Fever Cup is the most anticipated FIFA showdown, happening on
              October 11, 2023. Join us for an exhilarating gaming experience
              that will challenge your abilities. With limited spots available,
              register fast and secure your chance to shine on the virtual
              field. E-certificates are guaranteed for all participants. Don't
              miss this epic gaming event
            </p>
            <Link className="link" to="/events/#fifa" onClick={onPageChange}>
              <button className="events_btn">
                <svg
                  height="44px"
                  width="44px"
